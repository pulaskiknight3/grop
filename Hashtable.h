...
private:
    ...
    /**
     * @brief A vector of vectors to create a table of KeyValue pairs
     *
     */

    vector<vector <KeyValue>> table; 
    /**
     * @brief The number of elements within the hashtable
     *
     */
    int num_elements = 0; 
    // size_t capacity = std::vector<KeyValue *>().capacity(); 
};
